...
f.write("Based on the train and test errors observed,It is preferable to use LASSO for this problem.\n")
f.write("It is noteworthy that both LASSO and RIDGE regressions show more training error than Polynomial Regression and errors are actually increasing with lambda.\n")
f.write("_"*120+'\n')
f.close()     
